...
namespace ClinicService.Services.Impl
{
    public class ClientRepository : IClientRepository
    {
        ...
        public List<Client> GetAll()
        {
            ...
            {
                connection.Open();
                // Прописываем в команду SQL-запрос получить всех клиентов
                SqliteCommand command = connection.CreateCommand();
        ...
        public Client GetById(int id)
        {
            ...
            {
                connection.Open();
                // Прописываем в команду SQL-запрос получить конкретного клиента по Id
                SqliteCommand command = connection.CreateCommand();
            ...
            return null; // если не нашли, не прочитали Id, вернуть нул
        }
